...
const Navbar = () => {
    ...
    return (
        <header className="select-none text-gray-600 body-font sticky top-0 z-[1100] w-full dark:bg-slate-500 ">
            <div className="container mx-auto flex flex-wrap md:p-1 flex-row items-center justify-between md:justify-start absolute backdrop-blur bg-opacity-90 dark:bg-opacity-20">
                <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0 pt-2">
                ...
                <nav className="pl-10 md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400 flex flex-wrap items-center text-base justify-center">
